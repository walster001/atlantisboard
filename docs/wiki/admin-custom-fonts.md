...
The **Custom Fonts** panel lets you upload your own font files and use them throughout Atlantisboard. Uploaded fonts become available in font selectors across [Login Branding](admin-login-branding.md), [App Branding](admin-app-branding.md), and the default UI font setting.
...
Uploaded font files are stored in the **MinIO `fonts` bucket**. They are included in [backups](admin-backup.md) and will be restored when you restore from a backup archive.

---

## Related Pages

- [Login Branding](admin-login-branding.md) — use custom fonts for the app name and tagline on the login page.
- [App Branding](admin-app-branding.md) — set the default UI font for the entire application.
- [Backup & Restore](admin-backup.md) — font files are included in backup archives.
