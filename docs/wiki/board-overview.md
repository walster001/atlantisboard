...
- **Add list button** — located at the far end of the list row (left or right, depending on your [List Settings](board-settings-list.md) configuration), allowing you to create new lists.

### Scroll Zones

The board canvas includes auto-scroll zones at the left and right edges. When you drag a card or list near the edge of the screen, the board automatically scrolls in that direction to help you reach off-screen lists. See [Drag & Drop](drag-and-drop.md) for more details.
...
- [Lists & Columns](lists.md) — creating, renaming, and configuring lists.
- [Cards](cards.md) — card previews and creating cards.
- [Drag & Drop](drag-and-drop.md) — moving cards and lists.
- [Real-Time Collaboration](realtime.md) — how live updates work.
- [Board Settings: Card Settings](board-settings-card.md) — toggle card metadata visibility.
