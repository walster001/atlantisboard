...
- [Users & Permissions](board-settings-users.md) — Manage board members and role assignments.
- [Invites & Sharing](board-settings-invites.md) — Generate invite links that trigger `board.member.add` events.
- [Permissions & Roles](admin-permissions.md) — Configure the global role hierarchy and permission system.
