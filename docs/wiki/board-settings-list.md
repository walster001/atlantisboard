...
- [Lists & Columns](lists.md) — creating, renaming, and managing individual lists.
- [Board Settings: Card Settings](board-settings-card.md) — toggle card metadata visibility.
- [Board Overview](board-overview.md) — the board canvas where list settings take effect.
- [Cards](cards.md) — the cards that live within lists.
