...
1. Navigate to the [home page](home-page.md).
...
| **Export board** | Download the board in one of the supported export formats (CSV, Trello JSON, Wekan JSON, or Atlantisboard JSON). See [Exporting Boards](export.md). |
...
- [The Home Page](home-page.md) — home page layout and workspace sections.
- [Workspaces](workspaces.md) — organising boards into workspaces.
- [Board Overview](board-overview.md) — what you see when you open a board.
- [Exporting Boards](export.md) — export formats and how to download board data.
- [Theme & Colouring](board-settings-theme.md) — applying themes to boards.
