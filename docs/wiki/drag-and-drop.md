...
Drag-and-drop also works on the [home page](home-page.md):
...
- [Board Overview](board-overview.md) — the board canvas where lists and cards live.
- [Lists & Columns](lists.md) — creating and managing lists.
- [Cards](cards.md) — card previews and interactions.
- [The Home Page](home-page.md) — home page workspace and board tile drag-and-drop.
