...
- [Board Overview](board-overview.md) — the board layout where filters are applied.
- [Cards](cards.md) — the cards being filtered.
- [Card Detail](card-detail.md) — viewing full card information.
- [Board Settings: Card Settings](board-settings-card.md) — toggle which card elements are visible (affects what is searchable on preview).
