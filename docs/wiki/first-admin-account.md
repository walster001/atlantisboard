...
Once logged in as the founding admin, you can promote additional users to App Admin from the **Admin → Permissions & Roles** panel. Search for a user and toggle their App Admin status. See [Permissions & Roles](admin-permissions.md) for details.

---

## Next Steps

- [Initial Configuration Walkthrough](initial-configuration.md) — recommended order for setting up your new installation.
