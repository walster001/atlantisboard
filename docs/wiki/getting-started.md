...
- **Ready to install?** Start with the [System Requirements](system-requirements.md), then follow the [Docker Compose Installation](docker-compose-install.md) guide.
- **Already running?** Head to [Creating the First Admin Account](first-admin-account.md) to set up your initial user.
