...
Placeholder users appear with "Imported" or "Not Mapped" badges in the [Users & Permissions](board-settings-users.md) panel, where they can be managed or discarded.
...
- [Exporting Boards](export.md) — Create export files that can be re-imported.
- [User Management](admin-users.md) — Enable the Import Boards capability for users.
- [Permissions & Roles](admin-permissions.md) — Configure format-specific import permissions.
- [Users & Permissions (Board)](board-settings-users.md) — Manage placeholder users after import.
