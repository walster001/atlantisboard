...
> **Recommendation:** For most users, the [Docker Compose installation](docker-compose-install.md) is simpler and faster. Use this manual path only when Docker is not an option.
...
See the [Environment Variables Reference](environment-variables.md) for the complete list.
...
3. Proceed to [Creating the First Admin Account](first-admin-account.md).

---

## Next Steps

- [Reverse Proxy Setup](reverse-proxy.md) — add Nginx or Caddy for TLS and domain-based access.
- [Environment Variables Reference](environment-variables.md) — fine-tune your configuration.
- [Updating & Maintenance](updating.md) — how to update a manual installation.
