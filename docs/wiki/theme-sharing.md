...
4. Open the copy in the [Custom Theme Editor](theme-editor.md) to rename it and adjust colours.
...
Click **Edit** on any custom theme to open the [Custom Theme Editor](theme-editor.md). Changes are saved instantly and reflected on any boards currently using that theme.
...
- [Themes Overview](themes.md) — Understanding the theming system and all 8 default themes.
- [Custom Theme Editor](theme-editor.md) — Full guide to creating and editing custom themes.
- [Theme & Colouring (Board Settings)](board-settings-theme.md) — Applying themes within a board's settings.
- [Permissions & Roles](admin-permissions.md) — Configure which roles have theme-related permissions.
