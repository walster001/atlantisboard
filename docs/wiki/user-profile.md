...
- If your account is linked to a **Google account** (via [Google OAuth](google-oauth.md)), removing your uploaded avatar restores your **Google profile picture** as a fallback.
...
- Your avatar is stored in the MinIO `user-avatars` bucket and is included in [backups](admin-backup.md).
...
- [Password & Security](user-security.md) — change your password and set your theme preference.
- [Notification Preferences](user-notifications.md) — configure how you receive notifications.
- [Google OAuth Sign-In](google-oauth.md) — linking your Google account and profile picture fallback.
