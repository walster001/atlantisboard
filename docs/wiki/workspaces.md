...
A workspace is a named group of boards. On the [home page](home-page.md), each workspace appears as a section containing its board tiles. Workspaces help you:
...
1. Click the **Create Workspace** button on the home page (this button is only visible if you have the workspace creation capability — see [User Management](admin-users.md)).
...
- [The Home Page](home-page.md) — overall home page layout and navigation.
- [Creating & Managing Boards](create-board.md) — how to create boards within a workspace.
- [Permissions & Roles](admin-permissions.md) — understanding workspace-related permissions.
