...
![Database maintenance panel](/assets/wiki/admin-database.png)
...
![Cleanup categories](/assets/wiki/admin-database-cleanup.png)
...
- **Back up first** — For peace of mind, create a [backup](/wiki/admin-backup/) before running large cleanup operations.
...
- [Backup & Restore](/wiki/admin-backup/) — create a backup before performing database maintenance.
- [System Monitor](/wiki/admin-monitor/) — monitor overall system health including database size.
- [Environment Variables Reference](/wiki/environment-variables/) — database-related configuration.
