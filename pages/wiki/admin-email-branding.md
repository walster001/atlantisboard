...
![Email branding panel](/assets/wiki/admin-email-branding.png)
...
![Branded email preview](/assets/wiki/admin-email-branding-preview.png)
...
The `{{appName}}` variable is replaced with the application name configured in [Login Branding](/wiki/admin-login-branding/). This keeps your emails consistent with your branding without hardcoding the name.
...
- **Test your branding** — after saving, send a test email from the [Email (SMTP) Configuration](/wiki/admin-email/) panel to see your branded template in a real email client.
...
- [Email (SMTP) Configuration](/wiki/admin-email/) — configure your SMTP server and send test emails.
- [Login Branding](/wiki/admin-login-branding/) — set the app name used by the `{{appName}}` placeholder.
- [App Branding](/wiki/admin-app-branding/) — customise the in-app navbar and homepage.
