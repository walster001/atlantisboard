...
![SMTP configuration panel](/assets/wiki/admin-email-smtp.png)
...
![SMTP provider selector](/assets/wiki/admin-email-provider.png)
...
- [Login Options](/wiki/admin-login-options/) — enable mandatory email verification for new registrations.
- [Password Reset & Email Verification](/wiki/password-reset/) — how password reset emails work.
- [Email Branding](/wiki/admin-email-branding/) — customise the look and feel of outgoing emails.
- [Environment Variables Reference](/wiki/environment-variables/) — SMTP-related environment variables.
