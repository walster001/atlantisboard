...
![Login branding panel with live preview](/assets/wiki/admin-login-branding.png)
...
![Login branding preview example](/assets/wiki/admin-login-branding-preview.png)
...
![Login logo upload](/assets/wiki/admin-login-logo-upload.png)
...
| **Font family** | Selector | System UI | Choose from System UI or any [uploaded custom fonts](/wiki/admin-custom-fonts/). |
...
- [App Branding](/wiki/admin-app-branding/) — customise the in-app navbar and homepage appearance.
- [Email Branding](/wiki/admin-email-branding/) — customise outgoing email templates.
- [Custom Fonts](/wiki/admin-custom-fonts/) — upload fonts for use in branding selectors.
