...
![System monitor dashboard](/assets/wiki/admin-monitor.png)
...
![Monitor trend charts](/assets/wiki/admin-monitor-charts.png)
...
- [Backup & Restore](/wiki/admin-backup/) — check backup count and disk usage.
- [Database Maintenance](/wiki/admin-database/) — monitor database size and perform cleanup.
- [Environment Variables Reference](/wiki/environment-variables/) — server and logging configuration.
