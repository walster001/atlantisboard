...
![Permissions & roles panel](/assets/wiki/admin-permissions.png)
...
> **Note:** The [founding admin](/wiki/first-admin-account/) (first registered user) is permanently flagged but can still have their App Admin status revoked by another admin if needed.
...
![Custom role creation](/assets/wiki/admin-permissions-custom-role.png)
...
- [First Admin Account](/wiki/first-admin-account/) — how the founding App Admin is created.
- [Login Options](/wiki/admin-login-options/) — controlling who can register and how they authenticate.
- [Initial Configuration Walkthrough](/wiki/initial-configuration/) — where Permissions & Roles fits in the setup process.
