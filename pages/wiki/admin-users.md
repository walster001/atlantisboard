...
![User management panel](/assets/wiki/admin-users.png)
...
![User actions](/assets/wiki/admin-user-actions.png)
...
- Account lockouts triggered by three consecutive failed login attempts can be cleared from this panel using the **Unlock** action. See [Password & Security](/wiki/user-security/) for details on the lockout policy.
- For more information on configuring which roles users can be assigned on boards, see [Permissions & Roles](/wiki/admin-permissions/).
