...
![Board background settings](/assets/wiki/board-background.png)
...
Uses the canvas background colour defined by the currently active [theme](/wiki/board-settings-theme/). This is the default mode — the board background automatically matches your theme palette without any additional configuration.
...
![Custom background upload](/assets/wiki/board-background-upload.png)
...
- [Theme & Colouring](/wiki/board-settings-theme/) — Select and manage the board's colour theme.
- [Themes Overview](/wiki/themes/) — Learn about the full theming system.
- [Custom Theme Editor](/wiki/theme-editor/) — Create themes with custom canvas background colours.
