...
![Board card settings panel](/assets/wiki/board-settings-card.png)
...
Set a default background colour for newly created cards on this board. Individual cards can still have their colour overridden from the [Card Detail](/wiki/card-detail/) modal or the card context menu.
...
- [Cards](/wiki/cards/) — card preview anatomy and what each badge element means.
- [Card Detail](/wiki/card-detail/) — editing card properties in the detail modal.
- [Board Settings: List Settings](/wiki/board-settings-list/) — configuring list-level options like width and WIP limits.
- [Board Overview](/wiki/board-overview/) — the board layout where these settings take effect.
