...
![Board invites modal](/assets/wiki/board-invites.png)
...
- [Users & Permissions](/wiki/board-settings-users/) — Manage board members and roles directly.
- [Permissions & Roles](/wiki/admin-permissions/) — Configure the global permission system including invite-related permissions.
- [Registration & Sign-In](/wiki/accounts-auth/) — How invite-only registration mode works.
