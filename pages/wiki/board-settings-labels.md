...
![Board labels management](/assets/wiki/board-labels.png)
...
![Label colour picker](/assets/wiki/board-label-colours.png)
...
- **Board view** — Colour chips displayed on the card preview (when the "Labels" toggle is enabled in [Card Settings](/wiki/board-settings-card/)).
...
- Combine labels with the board [filter bar](/wiki/filtering-search/) to view only cards matching specific categories.
