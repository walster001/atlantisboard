...
![Board theme selector](/assets/wiki/board-theme-selector.png)
...
Any themes you've created via the [Custom Theme Editor](/wiki/theme-editor/) appear alongside system themes in the catalog. Custom themes are user-scoped — each user manages their own collection.
...
Click the **Add custom theme** button to open the [Custom Theme Editor](/wiki/theme-editor/) with a blank palette. You can then configure every colour slot, name your theme, and save it to your collection.
...
For full details on each colour slot, see the [Custom Theme Editor](/wiki/theme-editor/) documentation.

---

## Related Pages

- [Themes Overview](/wiki/themes/) — Complete guide to the theming system and all default themes.
- [Custom Theme Editor](/wiki/theme-editor/) — Create and edit your own themes.
- [Theme Sharing & Management](/wiki/theme-sharing/) — Permissions, applying, and managing themes.
- [Background](/wiki/board-settings-background/) — Configure the board background image or colour.
