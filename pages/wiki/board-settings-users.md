...
![Board members panel](/assets/wiki/board-members.png)
...
Custom roles created in the global [Permissions & Roles](/wiki/admin-permissions/) settings also appear in the role selector, each with their own configured permission set.
...
The change takes effect immediately and is logged in the board's [Audit Log](/wiki/board-settings-audit/).
...
- [Invites & Sharing](/wiki/board-settings-invites/) — Invite new users via link or email.
- [Permissions & Roles](/wiki/admin-permissions/) — Configure the global role and permission system.
- [Audit Log](/wiki/board-settings-audit/) — Track member additions, removals, and role changes.
