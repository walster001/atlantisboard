...
![Card detail modal](/assets/wiki/card-detail.png)
...
![Card description editor](/assets/wiki/card-description.png)
...
Each date can be set or cleared independently. Date badges appear on the [card preview](/wiki/cards/) on the board (toggleable in [Card Settings](/wiki/board-settings-card/)).
...
![Card reminders](/assets/wiki/card-reminders.png)
...
Reminders are delivered as push notifications (if configured — see [Notification Preferences](/wiki/user-notifications/)) and as in-app notifications.
...
- Labels are managed at the board level via [Board Settings → Labels](/wiki/board-settings-labels/).

Label chips appear on the card preview on the board when the "Labels" toggle is enabled in [Card Settings](/wiki/board-settings-card/).
...
- Assignee avatars appear on the [card preview](/wiki/cards/) (up to 4 shown, with a `+N` overflow indicator).
...
![Card checklist](/assets/wiki/card-checklist.png)
...
The overall checklist progress indicator is displayed on the card preview on the board (toggleable in [Card Settings](/wiki/board-settings-card/)).
...
![Card attachments](/assets/wiki/card-attachments.png)
...
- [Cards](/wiki/cards/) — card previews and creating cards on the board.
- [Board Settings: Card Settings](/wiki/board-settings-card/) — toggle which elements appear on card previews.
- [Filtering & Search](/wiki/filtering-search/) — find cards by label, member, or due date.
- [Real-Time Collaboration](/wiki/realtime/) — how changes sync across users.
