...
Cards are the fundamental units of work in Atlantisboard. Each card represents a task, idea, or item within a [list](/wiki/lists/). On the board, cards appear as compact preview tiles that surface key information at a glance.
...
2. Click the **Add card** button (located at the top or bottom of the list, depending on your [List Settings](/wiki/board-settings-list/) configuration for default card position).
...
Each card on the board displays a compact preview with several visual elements. Most of these can be individually toggled on or off from [Board Settings → Card Settings](/wiki/board-settings-card/).

![Card on the board](/assets/wiki/card-preview.png)
...
![Card with badges](/assets/wiki/card-badges.png)
...
Click anywhere on a card preview to open the full [Card Detail](/wiki/card-detail/) modal, where you can edit all card properties — description, dates, checklists, comments, attachments, and more.
...
Cards can be displayed in two sizes, configurable in [Board Settings → Card Settings](/wiki/board-settings-card/):
...
- [Card Detail](/wiki/card-detail/) — the full card editing experience with descriptions, checklists, comments, and more.
- [Lists & Columns](/wiki/lists/) — the lists that contain cards.
- [Drag & Drop](/wiki/drag-and-drop/) — moving cards between lists.
- [Board Settings: Card Settings](/wiki/board-settings-card/) — toggle which badge elements appear on card previews.
