...
![Home page overview](/assets/wiki/home-page.png)
...
1. **Navigation bar** — spans the top of the screen. Displays the brand icon and label (both customisable by an admin via [App Branding](/wiki/admin-app-branding/)), along with your user avatar and account menu on the right.
...
- **Brand icon and label** — defaults to the Atlantisboard logo and name. Admins can replace these under [App Branding](/wiki/admin-app-branding/).
...
- **Create Workspace** — the "Create Workspace" button appears for users who have the workspace creation capability. See [Workspaces](/wiki/workspaces/) for details.
- **Import** — an "Import" button is available for users with import permissions. See [Importing Boards](/wiki/import/) for supported formats.
...
![Board tiles grid](/assets/wiki/home-board-tiles.png)
...
- **Quick-access context menu** — a three-dot button that opens actions like rename, change colour, export, and delete. See [Creating & Managing Boards](/wiki/create-board/) for the full menu.
...
- [Workspaces](/wiki/workspaces/) — managing workspace settings, members, and descriptions.
- [Creating & Managing Boards](/wiki/create-board/) — the board creation modal and board card context menu.
- [App Branding](/wiki/admin-app-branding/) — customising the navbar icon, label, and homepage background.
