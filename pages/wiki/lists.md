...
![Lists on a board](/assets/wiki/lists.png)
...
1. Open a board.
2. Click the **Add list** button at the end of the list row (the position — left or right — is configurable in [List Settings](/wiki/board-settings-list/)).
...
See [Drag & Drop](/wiki/drag-and-drop/) for details on how the drag system works.
...
![List actions menu](/assets/wiki/list-actions.png)
...
- **Enable or disable** the card count badge from [Board Settings → Card Settings](/wiki/board-settings-card/) using the "Card counter on lists" toggle.
...
Configure WIP limits in [Board Settings → List Settings](/wiki/board-settings-list/).
...
- [Board Overview](/wiki/board-overview/) — overall board layout and navigation.
- [Cards](/wiki/cards/) — creating and managing cards within lists.
- [Drag & Drop](/wiki/drag-and-drop/) — reordering lists and moving cards.
- [Board Settings: Card Settings](/wiki/board-settings-card/) — toggle the card count badge.
