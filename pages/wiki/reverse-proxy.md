...
![Reverse proxy architecture](/assets/wiki/reverse-proxy-diagram.png)
...
- [Environment Variables Reference](/wiki/environment-variables/) — details on `TRUST_PROXY_HOPS`, `CORS_ORIGIN`, and `APP_URL`
- [Docker Compose Installation](/wiki/docker-compose-install/) — the default deployment setup
