...
![Default themes gallery](/assets/wiki/themes-default-gallery.png)
...
![Ocean Blue theme example](/assets/wiki/theme-ocean-blue.png)
...
![Sunset Orange theme example](/assets/wiki/theme-sunset-orange.png)
...
- **Readability** — All default themes are designed for comfortable extended use. Enable [Intelligent Contrast](/wiki/board-settings-theme/) for automatic accessibility adjustments.
...
2. **Create from scratch** — Open the [Custom Theme Editor](/wiki/theme-editor/) and build a completely new palette.

---

## Related Pages

- [Theme & Colouring (Board Settings)](/wiki/board-settings-theme/) — Apply themes to a specific board.
- [Custom Theme Editor](/wiki/theme-editor/) — Create and edit custom themes.
