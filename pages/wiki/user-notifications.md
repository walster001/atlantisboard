...
![Notification preferences](/assets/wiki/user-notifications.png)
...
1. Ensure the administrator has configured the `VAPID_SUBJECT` environment variable (see [Environment Variables Reference](/wiki/environment-variables/)).
...
- [Profile Settings](/wiki/user-profile/) — update your display name and avatar.
- [Password & Security](/wiki/user-security/) — change your password and theme preference.
- [Environment Variables Reference](/wiki/environment-variables/) — `VAPID_SUBJECT` configuration for push notifications.
- [Card Detail](/wiki/card-detail/) — how reminders, assignments, and comments work on cards.
