...
export const LOGIN_BRANDING_UPDATED_EVENT = 'kanboard:login-branding-updated';
...
export const APP_BRANDING_UPDATED_EVENT = 'kanboard:app-branding-updated';
...
export const FONTS_CATALOG_UPDATED_EVENT = 'kanboard:fonts-catalog-updated';
