...
import { BoardDayLogRetentionField } from './BoardDayLogRetentionField.js';
  ...
  return (
    <Box className={mobileLayout ? 'board-day-log board-day-log--mobile' : 'board-day-log'}>
      ...
      <Box className="board-day-log__surface">
        <BoardDayLogRetentionField
          ariaLabel={retentionAriaLabel}
          retentionValue={retentionValue}
          retentionSelectData={retentionSelectData}
          savingRetention={savingRetention}
          onRetentionChange={onRetentionChange}
          description={
            mobileLayout ? '' : 'Automatically delete old entries to manage database size'
          }
        />
