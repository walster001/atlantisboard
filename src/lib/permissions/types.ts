 ...
 * Each permission key maps to a specific action in the application.
 */
...
// Role permission set - defines which permissions a role has
export type RolePermissionSet = Set<PermissionKey>;
