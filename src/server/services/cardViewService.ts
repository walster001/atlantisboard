...
import type { ChecklistProgressDTO, CardDetailDTO, CardSummaryDTO, ViewMode } from '../../shared/types/viewModels.js';
import { extractPlainDescription } from '../utils/extractPlainTextFromRichJson.js';

export type CardViewMode = ViewMode;
...
export function toCardSummary(card: ICard): CardSummaryDTO {
  ...
  return {
    ...
    ...(card.endDate !== undefined ? { endDate: card.endDate } : {}),
