-- Add link_type column to board_invite_tokens
ALTER TABLE public.board_invite_tokens 
ADD COLUMN link_type text NOT NULL DEFAULT 'one_time' 
CHECK (link_type IN ('one_time', 'recurring'));

-- Update validate_and_redeem_invite_token to handle recurring links
